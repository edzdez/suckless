...
ResourcePref resources[] = {
    {"font", STRING, &font},         {"color0", STRING, &normbgcolor}, {"color4", STRING, &normfgcolor},
    {"color4", STRING, &selbgcolor}, {"color7", STRING, &selfgcolor},  {"color2", STRING, &urgbgcolor},
...
static Key keys[] = {
    ...
    {Mod1Mask | ShiftMask, XK_grave, spawn, SETPROP("_TABBED_SELECT_TAB")},
    {Mod1Mask | ShiftMask, XK_1, move, {.i = 0}},
    {Mod1Mask | ShiftMask, XK_2, move, {.i = 1}},
    {Mod1Mask | ShiftMask, XK_3, move, {.i = 2}},
    {Mod1Mask | ShiftMask, XK_4, move, {.i = 3}},
    {Mod1Mask | ShiftMask, XK_5, move, {.i = 4}},
    {Mod1Mask | ShiftMask, XK_6, move, {.i = 5}},
    {Mod1Mask | ShiftMask, XK_7, move, {.i = 6}},
    {Mod1Mask | ShiftMask, XK_8, move, {.i = 7}},
    {Mod1Mask | ShiftMask, XK_9, move, {.i = 8}},
    {Mod1Mask | ShiftMask, XK_0, move, {.i = 9}},
